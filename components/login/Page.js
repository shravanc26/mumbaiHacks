        ...
        <div>
            <section class="h-screen">
                <div class="container h-full px-6 py-24">
                    <div
                        class="g-6 flex h-full flex-wrap items-center justify-center lg:justify-between relative left-64">
                        ...
                        <div class="md:w-8/12 lg:ml-6 lg:w-5/12">
                            <div className='font-bold text-[3em] text-center m-10 underline'>
                                Login
                            </div>
                            <form>
                                <div class="relative mb-6" data-te-input-wrapper-init>
                                    <input
                                        type="text"
                                        class="peer block min-h-[auto] w-full rounded border-2 border-grey2 bg-transparent px-3 py-[0.32rem] leading-[2.15] outline-none transition-all duration-200 ease-linear 0"
                                ...
                                <div class="relative mb-6" data-te-input-wrapper-init>
                                    <input
                                        type="password"
                                        class="peer block min-h-[auto] w-full rounded bg-transparent  border-2 border-grey2 px-3 py-[0.32rem] leading-[2.15] outline-none transition-all duration-200 ease-linear "
                                    ...
                                    <div class="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem]">
                                        <input
                                            ...
                                            id="exampleCheck3"
                                             />
                                        <label
                                            class="inline-block pl-[0.15rem] hover:cursor-pointer hover:text-underline"
                                            for="exampleCheck3">
                                            Remember me
                                        </label>
                                    </div>
